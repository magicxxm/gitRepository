...
import com.mushiny.wms.schedule.common.Container;
import com.mushiny.wms.schedule.common.Dimension;
import com.mushiny.wms.schedule.common.Item;
import com.mushiny.wms.schedule.common.Packager;
...
public class BoxPackerBusiness {
    ...
    public String getBox(CustomerOrder customerOrder, List<ItemData> itemDataList) {
        ...
        if (boxAsc == null || boxAsc.isEmpty()) {
            throw new ApiException("", customerOrder.getClientId());
        }
        // 获取箱子
