...
public class IBPStationDTO extends BaseWarehouseAssignedDTO {
    ...
    private List<IBPStationPositionDTO> positions = new ArrayList<>();

    public IBPStationDTO() {
    }

    public IBPStationDTO(IBPStation entity) {
        super(entity);
    }
    ...
    public List<IBPStationPositionDTO> getPositions() {
        return positions;
    }

    public void setPositions(List<IBPStationPositionDTO> positions) {
