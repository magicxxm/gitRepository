...
public enum InventoryExceptionKey {
    ...
    GRPOS_HAS_NO_STOCK,
    REBATCH_EXISTS_FOR_UNITLOAD,
    REBATCH_ALREADY_FINISHED,
    REBATCH_NOT_FINIHED,
    NO_SUCH_REBATCHPOSITION,
    REBIN_NOT_FINIHED,
    REBIN_ALREADY_FINISHED,
    REBIN_CONFIRM_INVALID_AMOUNT
}
