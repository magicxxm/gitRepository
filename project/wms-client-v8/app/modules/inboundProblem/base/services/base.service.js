...
(function(){
  ...
  angular.module("myApp").service("problemInboundBaseService", function($translate, commonService, PROBLEM_INBOUND){
    return {
      // 首字母大写
      ...
      find: function(key, options, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_INBOUND["find"+ this.toUpper(key)],
          method: "GET",
      ...
      create: function(key, data, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_INBOUND["create"+ this.toUpper(key)],
          method: "POST",
          data: data,
          success: function(datas){
            cb && cb(datas.data);
      ...
      read: function(key, id, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_INBOUND["read"+ this.toUpper(key)].replace("#id#", id),
          method: "GET",
          success: function(datas){
            cb && cb(datas.data);
          }
      ...
      update: function(key, data, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_INBOUND["update"+ this.toUpper(key)],
          method: "PUT",
          data: data,
          success: function(datas){
            cb && cb(datas.data);
      ...
      deleteOne: function(key, id, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_INBOUND["delete"+ this.toUpper(key)].replace("#id#", id),
          method: "DELETE",
          success: function(datas){
            cb && cb(datas.data);
          }
