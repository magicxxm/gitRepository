(function () {
  ...
  angular.module("myApp").service('pprPlanConfigService', function (commonService, TOT_CONSTANT) {
    return {
      // 取tot statistics data
        getPprPlanConfigData: function (success,searchParams) {
        commonService.ajaxMushiny({
          url: TOT_CONSTANT.getPprPlanConfigData,
