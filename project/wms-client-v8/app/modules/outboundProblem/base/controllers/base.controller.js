    ...
    angular.module('myApp').controller("obpCtl", function ($rootScope, $scope, $state, $translate, $window, commonService, OBP_FILTER, problemOutboundBaseService) {
        ...
        function search(options, isSearchInWin) {
            ...
            var grid = $("#" + gridId).data(currentItem === "itemGroup" ? "kendoTreeList" : "kendoGrid"),
                filterItems = OBP_FILTER[currentItem] || [];
            ...
            commonService.dialogMushiny($scope.window, {
                ...
                open: function () {
                    ...
                    $rootScope.queryGridOptions = commonService.gridMushiny({
                        ...
                        dataSource: problemOutboundBaseService.getGridDataSource(options.srcKey),
                        height: height - 147
                    });
                    setTimeout(function () {
        ...
        // warehouse
        $rootScope.warehouseSource = problemOutboundBaseService.getDataSource({
            key: "getWarehouse",
            text: "name",
            value: "id"
        });
        ...
        // client
        $rootScope.clientSource = problemOutboundBaseService.getDataSource({
            key: "getClient",
            text: "name",
            value: "id"
        });
