...
public class SystemStocktakingPosition extends BaseClientAssignedEntity {
    ...
    private List<SystemStocktakingOrder> orders = new ArrayList<>();
    ...
    public List<SystemStocktakingOrder> getOrders() {
        return orders;
    }

    public void setOrders(List<SystemStocktakingOrder> orders) {
        this.orders = orders;
    }
}
