...
public class ReplenishmentPositionDTO extends BaseWarehouseAssignedDTO {
    ...
    public ReplenishmentPositionDTO() {
    }

    public ReplenishmentPositionDTO(ReplenishmentPosition entity) {
        super(entity);
    }
    ...
    public ReplenishmentDTO getReplenishment() {
        return replenishment;
    }

    public void setReplenishment(ReplenishmentDTO replenishment) {
