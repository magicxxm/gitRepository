 ...
 */
@Component
public class ModuleBusiness2 implements ApplicationContextAware {
    private static final Logger LOGGER = LoggerFactory.getLogger(ModuleBusiness2.class);
    private String uploadPath = "/";
    private String zipPath = "/";
    private Pattern zipPattern = Pattern.compile("jar|zip|war");
    private String separator = File.separator;
    private XmlUtils xu = new XmlUtils();
    private final String PROJECTDIR = "/home/mushiny/wms_v8/";
    ...
    public void test(String moduleName, Message message) {
        ...
        if (wcsRcsCmd.contains(moduleName)) {
            cmd = "sh /home/mushiny/wms_v8/startNew.sh rcs_wcs_check  " + moduleName;
            testParrern = Pattern.compile("check .* success pid .*");
        } else if(moduleName.contains("websocket")) {
            cmd = "sh /home/mushiny/wms_v8/startNew.sh check " + moduleName;
        ...
        try {
            ...
            if (copyResult == 1) {
                ...
                if (wcsRcsCmd.contains(param.get("moduleName"))) {
                    cmd.append("sh /home/mushiny/wms_v8/startNew.sh rcs_wcs_start ")
                            .append(" " + "/home/mushiny/wms_v8/" + param.get("moduleName") + "/")
                            .append(param.get("moduleName")).append(".jar");

                }else{
                    cmd.append("sh /home/mushiny/wms_v8/startNew.sh start")
                            .append(" " + param.get("moduleName"))
                            .append(" " + "/home/mushiny/wms_v8/" + param.get("moduleName") + "/")
                            .append(" " + param.get("modulePort"))
                            .append(" /home/mushiny/logs:/home/log");
                }
    ...
    public int stop(String moduleName, Message message) {
        ...
        Pattern testParrern;
        if (wcsRcsCmd.contains(moduleName)) {
            cmd = "sh /home/mushiny/wms_v8/startNew.sh rcs_wcs_stop " + moduleName;
            testParrern = Pattern.compile(".*杀死进程.*|程序没有启");
        } else {
            cmd = "sh /home/mushiny/wms_v8/startNew.sh stop " + moduleName;
