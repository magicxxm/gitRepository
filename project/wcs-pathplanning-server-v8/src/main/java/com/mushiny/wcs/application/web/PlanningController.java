...
public class PlanningController {
    ...
    public ResponseEntity<java.util.Map<String,Object> > getEmptyDrivePathDetail(@RequestParam String warehouseId,
                                                       @RequestParam String sectionId,
                                                       @RequestParam int sourceVertex,
                                                       @RequestParam int targetVertex)
    {
    ...
    public ResponseEntity<java.util.Map<String,Object> > getHeavyDrivePathDetail(@RequestParam String warehouseId,
                                                                                 @RequestParam String sectionId,
                                                                                 @RequestParam int sourceVertex,
                                                                                 @RequestParam int targetVertex)
    {
