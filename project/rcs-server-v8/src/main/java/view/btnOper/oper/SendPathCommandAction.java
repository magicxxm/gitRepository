 ...
 */
public class SendPathCommandAction extends DefaultButtonAction {

    private Pattern pathPattern;
    private String pathRex = "^(\\s*[1-9][0-9]*\\s*,)+(\\s*[1-9][0-9]*\\s*)$"; // 路径匹配正则表达式

    public SendPathCommandAction(AutoPathView autoPathView) {
        super(autoPathView);
        init();
    }
    private void init(){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        autoPathView.printLogAndClearLogBySize("发送路径:"+pathBean);
    }
