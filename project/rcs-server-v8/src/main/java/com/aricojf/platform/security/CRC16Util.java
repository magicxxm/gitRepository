 ...
 */
package com.aricojf.platform.security;
...
public class CRC16Util {
    ...
    /*public static void main(String[] args) {
        // 0xf360
        byte[] a = new byte[]{(byte)0xa5,0x5a, (byte)0xff, (byte)0xff, 0x00 ,0x01,0x02,0x03};
        int crc1 = CRC16Util.do_crc(a);
        System.out.println("方法1结果="+Integer.toHexString(crc1));
        int crc2 = getCRC1021(a);
        System.out.println("方法2结果="+Integer.toHexString(crc2));
         int crc3 = makeCRC(a);
        System.out.println("方法3结果="+Integer.toHexString(crc3));
