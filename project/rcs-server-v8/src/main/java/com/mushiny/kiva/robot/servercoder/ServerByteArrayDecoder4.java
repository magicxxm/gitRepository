 ...
 */
public class ServerByteArrayDecoder4 extends CumulativeProtocolDecoder {


    private boolean head = false;
    byte[] headData = new byte[1];
    private static Logger LOG = LoggerFactory.getLogger(ServerByteArrayDecoder4.class.getName());
    //解码
