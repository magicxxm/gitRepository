...
import com.mushiny.wcs.application.domain.enums.MapNodeClassValue;
import com.mushiny.wcs.application.repository.MapNodeRepository;
import com.mushiny.wcs.application.repository.MapRepository;
...
public class MapNodeConfig implements CommandLineRunner {
    ...
    private void init(List<SectionMapNode> sectionMapNodes, com.mushiny.wcs.application.domain.Map map, MapNode mapNode, List<MapNode> mapNodes) {
    ...
    public void run(String... args) throws Exception {
        ...
        List<com.mushiny.wcs.application.domain.Map> maps = mapRepository.findAllMap();
        for (com.mushiny.wcs.application.domain.Map map : maps) {
